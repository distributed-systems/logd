...
export default class TransportManager {
    ...
    addLogLevelDescriptor(descriptor: any) {
    ...
    computeRoute(transport: any) {
        transport.getLevels().forEach((level: any) => {
            switch (level.type) {
                case 'range':
    ...
    addTransportToLevel(transport: any, levelNumber: any){
