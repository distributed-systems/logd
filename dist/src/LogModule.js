...
export default class LogModule {
    constructor({ moduleName = '__root__', rootModule, parentFiles = [], logLevels = [] }) {
        ...
        if (args) {
            ...
            for (const arg of args) {
                ...
                if (typeof arg === 'object' && arg instanceof Error)
                    message.addDataObject(new ErrorMessage(arg));
                else
                    message.addData(arg);
            }
        }
    ...
    */
    isEnabled() {
        if (this.moduleIsEnabled === null)
            this.moduleIsEnabled = this.getEnabledStatus();
    ...
    */
    getLogLevels() {
        return this.getRootModule().getEnabledLogLevels();
    }
    /**
